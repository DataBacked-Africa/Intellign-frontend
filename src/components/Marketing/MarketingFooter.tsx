  ...
  return (
    <footer className="mk-container mk-footer">
      <div className="mk-footer__brand">
        ...
        <div className="desc">
          AI that solves your scheduling, routing, and assignment problems.
          Built and tested out of Africa, designed for every team that
      ...
      <div className="mk-footer__col">
        ...
        <Link href="/docs">Python SDK</Link>
